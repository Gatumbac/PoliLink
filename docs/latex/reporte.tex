...
Para el informe final se presenta una evidencia frontend por integrante y
cuatro capturas generales de la landing. Cada figura debe mostrar una
funcionalidad final ejecutándose en el navegador, con datos reales o de
demostración y sin herramientas de desarrollo visibles.

% Agregar estas seis capturas antes de entregar la fuente final:
% images/resultado-gabriel-eventos.png
% images/resultado-darwin-admin-comunidades.png
% images/resultado-general-landing-01-hero.png
% images/resultado-general-landing-02-metricas-eventos.png
% images/resultado-general-landing-03-comunidades-funciona.png
% images/resultado-general-landing-04-cta-final.png
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-gabriel-eventos.png}
\caption{Resultado de Gabriel: gestión de eventos propios del organizador con acceso a edición, cancelación y consulta de inscritos.}
\label{fig:resultado-gabriel-eventos}
\end{figure}

La evidencia de la figura~\ref{fig:resultado-gabriel-eventos} muestra una
actividad publicada por el organizador y las acciones disponibles para
editarla, cancelarla o consultar sus inscritos.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-darwin-admin-comunidades.png}
\caption{Resultado de Darwin: consulta de inscripciones, inscritos activos, cupo total y cupos disponibles de un evento.}
\label{fig:resultado-darwin}
\end{figure}

La evidencia de la figura~\ref{fig:resultado-darwin} muestra la funcionalidad
de inscripciones desarrollada por Darwin desde la vista del organizador. La
pantalla permite consultar los inscritos activos, el cupo total y los cupos
disponibles del evento.

\section{Vista general de la solución}

Además de las evidencias individuales, se incluyen cuatro capturas generales
de la landing para mostrar sus secciones principales. Estas imágenes son
complementarias y no sustituyen la evidencia de cada integrante.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-landing-01-hero.png}
\caption{Vista general de la landing: hero público con los accesos principales al catálogo de eventos y al directorio de comunidades.}
\label{fig:resultado-landing-hero}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-landing-02-metricas-eventos.png}
\caption{Vista general de la landing: métricas públicas y sección de eventos destacados.}
\label{fig:resultado-landing-eventos}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-landing-03-comunidades-funciona.png}
\caption{Vista general de la landing: comunidades disponibles y explicación de cómo funciona PoliLink.}
\label{fig:resultado-landing-comunidades}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-landing-04-cta-final.png}
\caption{Vista general de la landing: llamado final para explorar eventos, comunidades u organizar una comunidad.}
\label{fig:resultado-landing-cta}
\end{figure}

Las cuatro capturas generales muestran la landing completa por secciones, sin
repetir la evidencia individual de Gabriel.
