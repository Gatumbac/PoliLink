...
\centering
\small
\begin{tabularx}{\textwidth}{|p{7.1cm}|p{3.1cm}|p{2cm}|}
\hline
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{images/backend-1-login-organizador.png}
\caption{Inicio de sesión del organizador mediante la API de Laravel Sanctum.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{images/backend-2-crear-evento.png}
\caption{Creación de un evento por parte de un organizador autenticado.}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{images/backend-3-consultar-eventos.png}
\caption{Consulta del catálogo de eventos mediante la API REST.}
\end{figure}
