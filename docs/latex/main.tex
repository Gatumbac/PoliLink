...
% Agregar estas cinco capturas antes de entregar la fuente final:
% images/resultado-gabriel-landing.png
% images/resultado-darwin-admin-comunidades.png
% images/resultado-general-catalogo.png
% images/resultado-general-comunidades.png
% images/resultado-general-detalle-evento.png
\begin{figure}[H]
\centering
...
Además de las evidencias individuales, se incluyen tres capturas generales
para mostrar el recorrido público principal de PoliLink. Estas imágenes son
complementarias y no sustituyen las dos evidencias frontend exigidas, una por
integrante.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-catalogo.png}
\caption{Vista general: catálogo público de eventos con búsqueda, filtros y tarjetas de actividades.}
\label{fig:resultado-catalogo}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-comunidades.png}
\caption{Vista general: directorio público de comunidades con búsqueda y acceso a sus perfiles.}
\label{fig:resultado-comunidades}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/resultado-general-detalle-evento.png}
\caption{Vista general: detalle de un evento con información de la actividad, comunidad, cupos y opciones de participación.}
\label{fig:resultado-detalle-evento}
\end{figure}

Estas capturas permiten observar la navegación pública desde el catálogo hacia
el detalle de un evento y el directorio de comunidades.
