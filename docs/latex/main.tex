...
El frontend de PoliLink se desarrolló con React, TypeScript y Vite. La interfaz
utiliza componentes reutilizables, validación de formularios y un diseño
responsive para sus diferentes vistas.
...
\textbf{Implementación} & \textbf{Responsable} & \textbf{Estado} \\
\hline
Configuración del frontend, herramientas de desarrollo y estructura de la aplicación. & Gabriel Tumbaco & Hecho \\
\hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/frontend-darwin-01-inscripcion.png}
\caption{Detalle del evento visto por un estudiante autenticado, con la inscripción activa y la opción de cancelarla.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/frontend-darwin-02-mis-inscripciones.png}
\caption{Consulta de las inscripciones activas propias en \texttt{/mis-inscripciones}.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/frontend-darwin-03-cancelar-inscripcion.png}
\caption{Confirmación previa a la cancelación de una inscripción.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/frontend-darwin-04-inscritos.png}
\caption{Consulta de inscritos y cupos disponibles por parte del organizador responsable del evento.}
\end{figure}
